function [f_k, Sxx, Syy, Sxy, A_x, A_y, c_k_real_x, c_k_real_y, c_k_imag_x, c_k_imag_y, ...
    ...
    sigma_squared_based_on_Sxx, sigma_squared_based_on_Syy, sigma_squared_based_on_Sxy] ...
    ...
    Sxy = (conj(c_k_x) .* c_k_y) * (N_block / fsamp);
    Sxy = mean(Sxy,2);
